  ...
  return (
    ...
    >
      <div className="pt-20 xl:ml-56 xl:mb-56 flex flex-col justify-center items-center xl:items-start">
        <h1 className="mb-8 text-4xl md:text-6xl text-[#2D5677] font-bold text-center md:px-4">
        ...
        <form action="" className="flex flex-col justify-center w-full px-4 md:w-4/6">
          ...
          <div className="flex  xl:w-[32rem]">
            ...
            />
            <button className="xl:w-28 bg-[#2D5677] h-10 mt-2 mb-2 ml-4 px-4 text-[#ffffff]">
              ENTRAR
            </button>
          </div>
