...
const Login = () => {
  return (
    <div
      className="bg-cover bg-center w-screen  h-screen flex justify-between "
      style={{ backgroundImage: `url(${hero})` }}
    >
      <div className="ml-56 mb-56 flex flex-col justify-center">
        <h1 className="mb-8 text-6xl text-[#2D5677] font-bold">
          Bienvenido a Pladema
        </h1>
        <form action="" className="flex flex-col justify-center">
          <input
            ...
            className="w-[32rem] mt-2 mb-2 h-10 placeholder:pl-2"
          />
          <div className="flex">
            <input
              type="text"
              ...
              className="w-96 mt-2 mb-2 h-10 placeholder:pl-2"
            />
        ...
        <div className="flex flex-col mb-2 mt-2">
          <a href="" className="font-bold mb-2 w-52">
            ¿Olvidaste tu contraseña?
          </a>
          <a href="/register" className="font-bold w-56">
